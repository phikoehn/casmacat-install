...
function ajaxFileUpload() {
  ...
  $.ajaxFileUpload({
	url:'/?action=buildEngineOL&do=upload&input-extension=fr&output-extension=en',
	secureuri:false,
...
function showPublicCorpora() {
  ...
  var inputExtension = $('[name="input-extension"]').val();
  var outputExtension = $('[name="output-extension"]').val();
  $.ajax({ url: '/?action=buildEngineOL&do=public-corpora&input-extension=' + inputExtension + '&output-extension=' + outputExtension,
           method: 'get',
           dataType: 'html',
...
function uploadPublicCorpus( id, url, name ) {
  ...
  $.ajax({ url: '/?action=buildEngineOL&do=upload-public&url=' + encodeURIComponent( url ) + '&input-extension=' + inputExtension + '&output-extension=' + outputExtension + '&name=' + encodeURIComponent( name ),
           method: 'get',
           dataType: 'html',
           success: function(remoteData) {
             $(id).html(remoteData);
...
function refreshPreviousSettings() {
  var inputExtension = $('[name="input-extension"]').val();
  var outputExtension = $('[name="output-extension"]').val();
  $.ajax({ url: '/?action=buildEngineOL&do=get-previous-settings&input-extension=' + inputExtension + '&output-extension=' + outputExtension,
           method: 'get',
           dataType: 'json',
           success: function(remoteData) {
...
function refreshCorpusTable() {
  ...
  var inputExtension = $('[name="input-extension"]').val();
  var outputExtension = $('[name="output-extension"]').val();
  $.ajax({ url: '/?action=buildEngineOL&do=corpus-table&input-extension=' + inputExtension + '&output-extension=' + outputExtension,
           method: 'get',
           dataType: 'text',
           success: function(remoteData) {
